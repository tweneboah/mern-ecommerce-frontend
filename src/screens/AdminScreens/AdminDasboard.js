...
const AdminDasboard = props => {
  return (
    <div class='mt-5 fixed flex-grow flex flex-col'>
      <nav class=' w-1/3 px-2  space-y-1 bg-green-600' aria-label='Sidebar'>
        <a
          href='#'
          class='bg-gray-100 text-gray-900 group flex items-center px-2 py-2 text-sm font-mediumrounded-md'>
          <svg
