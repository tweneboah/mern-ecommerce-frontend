  ...
  return (
    <div>
      <div className='text-center h-min-screen m-4'>
        <p className='text-lg font-bold mb-3 mt-6'>Terms of Service</p>
        <p className='mb-4'>
          This website is operated by Blisspath Consult. Throughout the site,
          the terms “we”, and “us” refer to Blisspath Consult. Blisspath Consult
        ...
        <p className='mb-4'>
          ...
          terms and conditions and policies referenced herein. These Terms of
        ...
        <p className='text-lg font-bold'>Section 1 - Online Store Terms</p>
        <p className='mb-4'>
        ...
        <p className='text-lg font-bold mb-3'>Section 2 - General Conditions</p>
        <p className=' mb-3'>
        ...
        <p className='text-lg font-bold mb-3'>Section 7 - Optional Tools</p>
        <p className='mb-4'>
        ...
        <p className='text-lg font-bold mb-3'>Section 8 - Third-Party Links</p>
        <p className='mb-4'>
        ...
        <p className='text-lg font-bold mb-3'>Section 12 - Prohibited Uses</p>
        <p className='mb-4'>
          the site or its content: (a) for any unlawful purpose; (b) to solicit
        ...
        <p className='mb-4'>
          ...
          non-infringement. In no case shall Blisspath Consult, our directors,
        ...
        <p className='text-lg font-bold mb-3'>Section 14 - Indemnification</p>
        <p className='mb-4'>
          You agree to indemnify, defend and hold harmless Blisspath Consult and
        ...
        <p className='text-lg font-bold mb-3'>Section 15 - Severability</p>
        <p className='mb-4'>
        ...
        <p className='text-lg font-bold mb-3'>Section 16 - Termination</p>
        <p className='mb-4'>
        ...
        <p className='text-lg font-bold mb-3'>Section 17 - Entire Agreement</p>
        <p className='mb-4'>
        ...
        <p className='text-lg font-bold mb-3'>Section 18 - Governing Law</p>
        <p className='mb-4'>
